...
const Filter = () => {
  ...
  const handleChange = (event, newValue) => {
	...
	// getWeatherForecast({latitude: '20.23', longitude: '85.83',  tabValue: 1})
	// .then(apiResponse => 
	// 	console.log(apiResponse)
	// );

	// getWeatherForecast({latitude: '20.23', longitude: '85.83',  tabValue: 0})
	// .then(apiResponse => 
	// 	console.log(apiResponse)
	// );

	// getCurrentWeather({latitude: '20.23', longitude: '85.83',  tabValue: 1})
	// 	.then(apiResponse => 
	// 		console.log(apiResponse)
	// 	);
